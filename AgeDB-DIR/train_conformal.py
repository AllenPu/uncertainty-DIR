...
### either CQR, LS
parser.add_argument('--CQR', action='store_true', help='default  CQR usage of the conformal regression for estimating the variance')
...
def get_data_loader(args):
    ...
    #
    print(f"---Prepare--{args.reweight}-----{args.smooth}-----")
    #
